...
namespace Project1
{
    internal class HUD
    {
        ...
        public static void Draw(SpriteBatch _spriteBatch)
        {
            ...
            {
                _spriteBatch.Draw(_textureBouclierHUD, pos + new Vector2(0, 135), Color.White);
                _spriteBatch.DrawString(Message._police,"Invincible " + (3 - Math.Round(Perso._waitBouclier,0)) + "s", pos + new Vector2(55, 150), Color.White);
            }
        }
