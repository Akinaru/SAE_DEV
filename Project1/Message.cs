...
namespace Project1
{
    internal class Message
    {
        ...
        public static void Draw(SpriteBatch _spriteBatch, String message, String message2)
        {
            ...
            _spriteBatch.DrawString(Message._police, "Fee clocharde: ", _positionMessageTexte + new Vector2(0, -18), Color.Black);
            _spriteBatch.DrawString(Message._police, message, _positionMessageTexte, Color.Black);
            _spriteBatch.DrawString(Message._police, message2, _positionMessageTexte + new Vector2(0, 18), Color.Black);
